                    ...
                    Tambah Siswa
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                                        <option style="font-weight:bold;" value="laki-laki">Laki - laki</option>
                                        <option style="font-weight:bold;" value="perempuan">Perempuan</option>
                                </select>
                                </div>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#moll<?=$blog['id']?>">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="form-group">
                                <label style="font-weight:bold;" for="nama">Jenis Kelamin</label>
